...
class ConductorStyles {
  ...
  static const String appTitle = "RutaMóvil Conductor";
  ...
  // Íconos del drawer con estilo moderno (específicos para conductor)
  static const Icon inicioIcon = Icon(Icons.dashboard_rounded, size: 24);
  static const Icon rutasIcon = Icon(Icons.route_rounded, size: 24);
  static const Icon viajesIcon = Icon(Icons.drive_eta_rounded, size: 24);
  ...
  static const Icon vehiculoIcon = Icon(Icons.directions_car_rounded, size: 24);
  static const Icon reportesIcon = Icon(Icons.assessment_rounded, size: 24);
  ...
  static const String appName = "RutaMóvil Conductor";
  static const String appVersion = "1.0.0";
  static const String appLegalese = "© 2025 RutaMóvil - Transporte Rural";
  static const String appDescription = "Panel de conductor para transporte rural";

  // Tema para la aplicación del conductor
  static ThemeData conductorTheme = ThemeData(
    useMaterial3: true,
